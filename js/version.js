...
const APP_VERSION = {
    ...
    changelog: [
        'v1.3.93 - 修复拆分任务进度显示问题：任务模式下顶部进度格子严格按照子任务wordIds数量和progress.completed计算，不再出现显示整套题数量的情况；增加练习过程调试日志：Practice.logDebugEvent收集每题提交/拦截等事件，诊断弹窗中支持查看并一键复制调试JSON；版本一致性守卫继续保障GitHub Pages+iPad始终使用同一版代码',
